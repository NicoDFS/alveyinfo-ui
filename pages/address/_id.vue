<template>
  <section class="container">
        ...
        <div class="columns">
          ...
          <div class="column info-value monospace">
            ...
            <span v-if="unconfirmed !== '0' && staking !== '0'">
              ({{ unconfirmed | alvey }} ALVEY {{ $t('address.unconfirmed') }},
              {{ staking | alvey }} ALVEY {{ $t('address.staking') }})
            </span>
    ...
    <nuxt-child :tokens="arc20Balances.map(({address, name, symbol}) => ({address, name, symbol}))" />
  </section>
</template>
