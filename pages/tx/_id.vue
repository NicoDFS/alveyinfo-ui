    ...
    <div class="card section-card">
      ...
      <div class="card-body info-table">
        ...
        <div class="columns" v-if="fees > 0">
          ...
          <div class="column info-value monospace">{{ fees | alvey }} ALVEY</div>
        </div>
        ...
        <Transaction
          :transaction="{
            ...
            contractSpends,
            arc20TokenTransfers, qrc721TokenTransfers
          }"
          detailed
  ...
  export default {
    ...
    async asyncData({req, params, error}) {
      try {
        ...
        return {
          ...
          arc20TokenTransfers: transaction.arc20TokenTransfers,
    ...
    methods: {
      refresh(transaction) {
        ...
        this.arc20TokenTransfers = transaction.arc20TokenTransfers
